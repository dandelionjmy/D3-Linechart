   ...
   /* **/
    ...
    function module() {
        ...
        */
        ...
        /** @function module:datamanager.original_dataset
        ...
        *
        * example_datamanager.original_dataset();
        * */ 
        /* **/
        data_manager.original_dataset = function(_x) {
            if (!arguments.length) { return original_dataset; }
            else { original_dataset = _x; }
            return this;
        }
        ...
        * */ 
        /* **/
        data_manager.update_model_fn = function(_x) {
            if (!arguments.length) { return update_model_fn; }
            else { update_model_fn = _x; }
            return this;
        }
        ...
        * */ 
        /* **/
        data_manager.update_model = function(context) {
            update_model_fn(context, original_dataset);
            return this;
        }
        ...
        * */ 
        /* **/
        data_manager.model_data = function(_x) {
